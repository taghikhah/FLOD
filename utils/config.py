...
def get_args():
    ...
    parser.add_argument('--eta', '-et', type=float, default=1e-6,
                        help='ETA min value for CosineAnnealingLR scheduler.')
    parser.add_argument('--momentum', '-mo', type=float, default=0.9, 
                        help='Momentum value for SGD optimizers.')
    ...
    parser.add_argument('--evalutaion-methods', '-em', type=str, nargs='+', default=['FLOD'],
                        choices=['Mahalanobis', 'FLOD', 'MSP', 'ODIN', 'Energy', 'GEM', 'OE'],
